...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*OpenStackDisk)(nil), (*openstack.OpenStackDisk)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_OpenStackDisk_To_openstack_OpenStackDisk(a.(*OpenStackDisk), b.(*openstack.OpenStackDisk), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*openstack.OpenStackDisk)(nil), (*OpenStackDisk)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_openstack_OpenStackDisk_To_v1alpha1_OpenStackDisk(a.(*openstack.OpenStackDisk), b.(*OpenStackDisk), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_MachineProviderConfigSpec_To_openstack_MachineProviderConfigSpec(in *MachineProviderConfigSpec, out *openstack.MachineProviderConfigSpec, s conversion.Scope) error {
	...
	out.Disks = *(*[]openstack.OpenStackDisk)(unsafe.Pointer(&in.Disks))
	return nil
}
...
func autoConvert_openstack_MachineProviderConfigSpec_To_v1alpha1_MachineProviderConfigSpec(in *openstack.MachineProviderConfigSpec, out *MachineProviderConfigSpec, s conversion.Scope) error {
	...
	out.Disks = *(*[]OpenStackDisk)(unsafe.Pointer(&in.Disks))
	return nil
}
...
func autoConvert_v1alpha1_OpenStackDisk_To_openstack_OpenStackDisk(in *OpenStackDisk, out *openstack.OpenStackDisk, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = in.Type
...
// Convert_v1alpha1_OpenStackDisk_To_openstack_OpenStackDisk is an autogenerated conversion function.
func Convert_v1alpha1_OpenStackDisk_To_openstack_OpenStackDisk(in *OpenStackDisk, out *openstack.OpenStackDisk, s conversion.Scope) error {
	return autoConvert_v1alpha1_OpenStackDisk_To_openstack_OpenStackDisk(in, out, s)
}

func autoConvert_openstack_OpenStackDisk_To_v1alpha1_OpenStackDisk(in *openstack.OpenStackDisk, out *OpenStackDisk, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = in.Type
	out.Metadata = *(*map[string]string)(unsafe.Pointer(&in.Metadata))
	out.Size = in.Size
...
// Convert_openstack_OpenStackDisk_To_v1alpha1_OpenStackDisk is an autogenerated conversion function.
func Convert_openstack_OpenStackDisk_To_v1alpha1_OpenStackDisk(in *openstack.OpenStackDisk, out *OpenStackDisk, s conversion.Scope) error {
	return autoConvert_openstack_OpenStackDisk_To_v1alpha1_OpenStackDisk(in, out, s)
}
