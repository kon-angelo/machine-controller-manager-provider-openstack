...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenStackDisk) DeepCopyInto(out *OpenStackDisk) {
	*out = *in
	if in.Metadata != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenStackDisk.
func (in *OpenStackDisk) DeepCopy() *OpenStackDisk {
	if in == nil {
		return nil
	}
	out := new(OpenStackDisk)
	in.DeepCopyInto(out)
	return out
}
